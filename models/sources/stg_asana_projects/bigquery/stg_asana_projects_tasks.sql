...
renamed AS (
  ...
  cast(null as float64) as task_story_points,
  ...
  null as total_revision_required,
  null as total_failed_internal_qa,
  ...
  1 as total_issues,
  cast(null as timestamp) as last_task_start_ts,
